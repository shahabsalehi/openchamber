export const SANDBOX_ERROR_CODES = Object.freeze({
  ...
  COMMAND_TERMINAL_MISSING: 'SANDBOX_COMMAND_TERMINAL_MISSING',
  COMMAND_PROTOCOL_INVALID: 'SANDBOX_COMMAND_PROTOCOL_INVALID',
...
const ERROR_MESSAGES = Object.freeze({
  ...
  [SANDBOX_ERROR_CODES.COMMAND_TERMINAL_MISSING]: 'Sandbox command stream ended without a terminal event',
  [SANDBOX_ERROR_CODES.COMMAND_PROTOCOL_INVALID]: 'Sandbox command protocol response is invalid',
