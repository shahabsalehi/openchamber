...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    keywords: ['discord', 'slash', 'commands', 'help', 'status', 'schedule', 'mcp', 'worktrees'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'integrations.discord.proxy-worktrees',
    page: 'integrations',
    titleKey: 'settings.integrations.discord.bridge.proxyNote',
    descriptionKey: 'settings.integrations.discord.bridge.autoWorktreeNote',
    keywords: ['discord', 'proxy', 'http_proxy', 'https_proxy', 'no_proxy', 'worktree'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
  ...
  },
  {
    ...
    descriptionKey: 'settings.integrations.discord.bridge.notifyOnComplete.description',
    keywords: ['discord', 'mention', 'notify', 'completion', 'done'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'integrations.discord.interrupt-timeout',
    page: 'integrations',
    titleKey: 'settings.integrations.discord.bridge.interruptTimeout.title',
    descriptionKey: 'settings.integrations.discord.bridge.interruptTimeout.description',
    keywords: ['discord', 'interrupt', 'supersede', 'abort', 'timeout'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
] as const;
