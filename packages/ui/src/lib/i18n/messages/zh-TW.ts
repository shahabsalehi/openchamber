...
export const dict: Record<I18nKey, string> = {
  ...
  'shareOpinion.actions.shareOpinion': '分享意見',
  'shareOpinion.actions.bookCall': '預約通話',
  'shareOpinion.actions.shortSurvey': '簡短問卷',
  'shareOpinion.dialog.title': '分享你的意見',
  'shareOpinion.toast.title': '協助塑造 OpenChamber',
  'shareOpinion.toast.description': '告訴我們哪些有用、令人困惑或缺少什麼，協助塑造下一步。',
  'sessions.sidebar.footer.actions.shareOpinion': '分享意見',
