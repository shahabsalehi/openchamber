...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.copyReference': '複製會話參考',
  ...
  'sessions.sidebar.session.reference.success': '會話參考已複製',
  'sessions.sidebar.session.reference.copyError': '無法複製會話參考',
