...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.desktopNetwork.field.windowControlsPositionDescription': '최소화, 최대화, 닫기 버튼이 표시될 위치를 선택합니다. 자동은 운영체제를 따릅니다.',
  'settings.openchamber.desktopNetwork.field.windowControlsPositionAria': '창 컨트롤 위치',
  'settings.openchamber.desktopNetwork.option.windowControlsAuto': '자동',
  ...
  'settings.providers.webV2Credentials.title': '관리되는 자격 증명', 'settings.providers.webV2Credentials.info': '관리되는 공급자 자격 증명을 만들고, 교체하고, 해지하거나 삭제합니다. 입력한 값은 다시 표시되지 않습니다.', 'settings.providers.webV2Credentials.error.load': '관리되는 자격 증명을 불러올 수 없습니다. 마지막으로 불러온 자격 증명은 계속 사용할 수 있습니다.', 'settings.providers.webV2Credentials.error.mutation': '자격 증명을 업데이트할 수 없습니다. 값을 확인하고 다시 시도하세요.',
  'settings.providers.webV2Credentials.create.nameLabel': '자격 증명 이름', 'settings.providers.webV2Credentials.create.namePlaceholder': 'production-openai', 'settings.providers.webV2Credentials.create.nameAria': '자격 증명 이름', 'settings.providers.webV2Credentials.create.valueLabel': '자격 증명 값', 'settings.providers.webV2Credentials.create.valuePlaceholder': '새 자격 증명 값 입력', 'settings.providers.webV2Credentials.create.valueAria': '새 자격 증명 값',
  'settings.providers.webV2Credentials.list.title': '관리되는 자격 증명', 'settings.providers.webV2Credentials.rotate.valueLabel': '새 자격 증명 값', 'settings.providers.webV2Credentials.rotate.valuePlaceholder': '대체 자격 증명 값 입력', 'settings.providers.webV2Credentials.rotate.valueAria': '{name}의 새 자격 증명 값',
  'settings.providers.webV2Credentials.metadata.provider': '공급자: {provider}', 'settings.providers.webV2Credentials.metadata.generation': '세대 {generation}', 'settings.providers.webV2Credentials.metadata.created': '생성 {timestamp}', 'settings.providers.webV2Credentials.metadata.updated': '업데이트 {timestamp}', 'settings.providers.webV2Credentials.status.active': '활성', 'settings.providers.webV2Credentials.status.revoked': '해지됨', 'settings.providers.webV2Credentials.state.loading': '관리되는 자격 증명 불러오는 중…', 'settings.providers.webV2Credentials.state.empty': '관리되는 자격 증명이 아직 없습니다.',
  'settings.providers.webV2Credentials.actions.create': '만들기', 'settings.providers.webV2Credentials.actions.creating': '만드는 중…', 'settings.providers.webV2Credentials.actions.refresh': '새로 고침', 'settings.providers.webV2Credentials.actions.rotate': '교체', 'settings.providers.webV2Credentials.actions.rotating': '교체 중…', 'settings.providers.webV2Credentials.actions.revoke': '해지', 'settings.providers.webV2Credentials.actions.revoking': '해지 중…', 'settings.providers.webV2Credentials.actions.delete': '삭제', 'settings.providers.webV2Credentials.actions.deleting': '삭제 중…', 'settings.providers.webV2Credentials.actions.cancel': '취소',
  'settings.providers.webV2Credentials.confirm.revokeTitle': '자격 증명을 해지할까요?', 'settings.providers.webV2Credentials.confirm.revokeDescription': '{name}을(를) 사용할 수 없게 됩니다. 나중에 교체할 수 있습니다.', 'settings.providers.webV2Credentials.confirm.deleteTitle': '자격 증명을 삭제할까요?', 'settings.providers.webV2Credentials.confirm.deleteDescription': '{name}을(를) 영구적으로 삭제합니다. 이 작업은 취소할 수 없습니다.',
} as const;
