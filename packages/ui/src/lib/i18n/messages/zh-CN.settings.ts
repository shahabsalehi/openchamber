...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.desktopNetwork.field.windowControlsPositionDescription': '选择最小化、最大化和关闭按钮的显示位置。自动会按操作系统决定。',
  'settings.openchamber.desktopNetwork.field.windowControlsPositionAria': '窗口控件位置',
  'settings.openchamber.desktopNetwork.option.windowControlsAuto': '自动',
  ...
  'settings.providers.webV2Credentials.title': '托管凭据', 'settings.providers.webV2Credentials.info': '创建、轮换、撤销或删除托管的提供商凭据。输入后不会再显示凭据值。', 'settings.providers.webV2Credentials.error.load': '无法加载托管凭据。上次加载的凭据仍可用。', 'settings.providers.webV2Credentials.error.mutation': '无法更新凭据。请检查值后重试。',
  'settings.providers.webV2Credentials.create.nameLabel': '凭据名称', 'settings.providers.webV2Credentials.create.namePlaceholder': 'production-openai', 'settings.providers.webV2Credentials.create.nameAria': '凭据名称', 'settings.providers.webV2Credentials.create.valueLabel': '凭据值', 'settings.providers.webV2Credentials.create.valuePlaceholder': '输入新的凭据值', 'settings.providers.webV2Credentials.create.valueAria': '新的凭据值', 'settings.providers.webV2Credentials.list.title': '托管凭据', 'settings.providers.webV2Credentials.rotate.valueLabel': '新的凭据值', 'settings.providers.webV2Credentials.rotate.valuePlaceholder': '输入替换凭据值', 'settings.providers.webV2Credentials.rotate.valueAria': '{name} 的新凭据值',
  'settings.providers.webV2Credentials.metadata.provider': '提供商：{provider}', 'settings.providers.webV2Credentials.metadata.generation': '代次 {generation}', 'settings.providers.webV2Credentials.metadata.created': '创建于 {timestamp}', 'settings.providers.webV2Credentials.metadata.updated': '更新于 {timestamp}', 'settings.providers.webV2Credentials.status.active': '有效', 'settings.providers.webV2Credentials.status.revoked': '已撤销', 'settings.providers.webV2Credentials.state.loading': '正在加载托管凭据…', 'settings.providers.webV2Credentials.state.empty': '尚无托管凭据。',
  'settings.providers.webV2Credentials.actions.create': '创建', 'settings.providers.webV2Credentials.actions.creating': '正在创建…', 'settings.providers.webV2Credentials.actions.refresh': '刷新', 'settings.providers.webV2Credentials.actions.rotate': '轮换', 'settings.providers.webV2Credentials.actions.rotating': '正在轮换…', 'settings.providers.webV2Credentials.actions.revoke': '撤销', 'settings.providers.webV2Credentials.actions.revoking': '正在撤销…', 'settings.providers.webV2Credentials.actions.delete': '删除', 'settings.providers.webV2Credentials.actions.deleting': '正在删除…', 'settings.providers.webV2Credentials.actions.cancel': '取消', 'settings.providers.webV2Credentials.confirm.revokeTitle': '撤销凭据？', 'settings.providers.webV2Credentials.confirm.revokeDescription': '这将停止使用 {name}。之后仍可轮换它。', 'settings.providers.webV2Credentials.confirm.deleteTitle': '删除凭据？', 'settings.providers.webV2Credentials.confirm.deleteDescription': '这将永久删除 {name}。此操作无法撤销。',
} as const;
