...
export const dict: Record<I18nKey, string> = {
  ...
  'shareOpinion.actions.shareOpinion': '의견 공유',
  'shareOpinion.actions.bookCall': '통화 예약',
  'shareOpinion.actions.shortSurvey': '짧은 설문',
  'shareOpinion.dialog.title': '의견을 공유해 주세요',
  'shareOpinion.toast.title': 'OpenChamber의 방향을 함께 만들어 주세요',
  'shareOpinion.toast.description': '유용한 점, 혼란스러운 점, 부족한 점을 알려 주셔서 다음 방향을 함께 만들어 주세요.',
  'sessions.sidebar.footer.actions.shareOpinion': '의견 공유',
