...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.copyReference': '세션 참조 복사',
  ...
  'sessions.sidebar.session.reference.success': '세션 참조가 복사됨',
  'sessions.sidebar.session.reference.copyError': '세션 참조 복사 실패',
