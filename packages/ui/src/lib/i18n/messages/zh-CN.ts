...
export const dict: Record<I18nKey, string> = {
  ...
  'helpDialog.item.createNewWorktreeDraft': '创建新 Worktree 草稿',
  ...
  'chat.textSelection.title.saveInsightToNotes': '将洞察保存到笔记',
  ...
  'onboarding.localSetup.windows.title': 'Windows 设置（推荐 WSL）',
  'onboarding.localSetup.windows.stepInstallWsl': '如需，请先在 PowerShell 中运行',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，建议在 WSL 中安装并运行 OpenCode 以获得最佳兼容性。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若检测失败，请设置本地路径（opencode.cmd/opencode.exe）、wsl.exe，或 wsl:/usr/local/bin/opencode。',
  ...
  'vscodeLayout.actions.openAgentManagerAria': '打开 Agent 管理器',
