...
export const dict: Record<I18nKey, string> = {
  ...
  'shareOpinion.actions.shareOpinion': '分享意见',
  'shareOpinion.actions.bookCall': '预约通话',
  'shareOpinion.actions.shortSurvey': '简短问卷',
  'shareOpinion.dialog.title': '分享你的意见',
  'shareOpinion.toast.title': '帮助塑造 OpenChamber',
  'shareOpinion.toast.description': '告诉我们哪些有用、令人困惑或缺失，帮助塑造下一步。',
  'sessions.sidebar.footer.actions.shareOpinion': '分享意见',
