...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.copyReference': '复制会话引用',
  ...
  'sessions.sidebar.session.reference.success': '会话引用已复制',
  'sessions.sidebar.session.reference.copyError': '无法复制会话引用',
