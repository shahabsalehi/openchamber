...
export const dict: Record<I18nKey, string> = {
  ...
  "diffView.mode.single.description": "Показувати по одному файлу",
  "diffView.mode.stacked.label": "Усі файли",
  "diffView.mode.stacked.description": "Показувати всі змінені файли разом",
  "diffView.selector.selectFile": "Вибрати файл",
  "diffView.selector.viewMode": "Режим перегляду",
  ...
  "chat.textSelection.title.saveInsightToNotes": "Зберегти стислий інсайт у нотатках",
  ...
  "onboarding.localSetup.windows.title": "Налаштування Windows (рекомендується WSL)",
  "onboarding.localSetup.windows.stepInstallWsl": "Встановіть WSL (за потреби) за допомогою",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "У Windows інсталюйте та запустіть OpenCode у WSL для найкращої сумісності.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Якщо виявлення з помилкою, установіть власний шлях (opencode.cmd/opencode.exe), wsl.exe або wsl:/usr/local/bin/opencode.",
