...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.desktopNetwork.field.windowControlsPositionDescription": "Elige dónde aparecen los botones de minimizar, maximizar y cerrar. Automático sigue el sistema operativo.",
  ...
  'settings.providers.webV2Credentials.title': 'Credenciales gestionadas',
  'settings.providers.webV2Credentials.info': 'Crea, rota, revoca o elimina credenciales de proveedor gestionadas. Los valores no se muestran después de introducirlos.',
  'settings.providers.webV2Credentials.error.load': 'No se pudieron cargar las credenciales gestionadas. Las últimas credenciales cargadas siguen disponibles.',
  'settings.providers.webV2Credentials.error.mutation': 'No se pudo actualizar la credencial. Revisa el valor e inténtalo de nuevo.',
  'settings.providers.webV2Credentials.create.nameLabel': 'Nombre de credencial', 'settings.providers.webV2Credentials.create.namePlaceholder': 'produccion-openai', 'settings.providers.webV2Credentials.create.nameAria': 'Nombre de credencial',
  'settings.providers.webV2Credentials.create.valueLabel': 'Valor de credencial', 'settings.providers.webV2Credentials.create.valuePlaceholder': 'Introduce un nuevo valor de credencial', 'settings.providers.webV2Credentials.create.valueAria': 'Nuevo valor de credencial',
  'settings.providers.webV2Credentials.list.title': 'Credenciales gestionadas', 'settings.providers.webV2Credentials.rotate.valueLabel': 'Nuevo valor de credencial', 'settings.providers.webV2Credentials.rotate.valuePlaceholder': 'Introduce un valor de reemplazo', 'settings.providers.webV2Credentials.rotate.valueAria': 'Nuevo valor de credencial para {name}',
  'settings.providers.webV2Credentials.metadata.provider': 'Proveedor: {provider}', 'settings.providers.webV2Credentials.metadata.generation': 'Generación {generation}', 'settings.providers.webV2Credentials.metadata.created': 'Creada {timestamp}', 'settings.providers.webV2Credentials.metadata.updated': 'Actualizada {timestamp}',
  'settings.providers.webV2Credentials.status.active': 'Activa', 'settings.providers.webV2Credentials.status.revoked': 'Revocada', 'settings.providers.webV2Credentials.state.loading': 'Cargando credenciales gestionadas…', 'settings.providers.webV2Credentials.state.empty': 'Aún no hay credenciales gestionadas.',
  'settings.providers.webV2Credentials.actions.create': 'Crear', 'settings.providers.webV2Credentials.actions.creating': 'Creando…', 'settings.providers.webV2Credentials.actions.refresh': 'Actualizar', 'settings.providers.webV2Credentials.actions.rotate': 'Rotar', 'settings.providers.webV2Credentials.actions.rotating': 'Rotando…', 'settings.providers.webV2Credentials.actions.revoke': 'Revocar', 'settings.providers.webV2Credentials.actions.revoking': 'Revocando…', 'settings.providers.webV2Credentials.actions.delete': 'Eliminar', 'settings.providers.webV2Credentials.actions.deleting': 'Eliminando…', 'settings.providers.webV2Credentials.actions.cancel': 'Cancelar',
  'settings.providers.webV2Credentials.confirm.revokeTitle': '¿Revocar credencial?', 'settings.providers.webV2Credentials.confirm.revokeDescription': 'Esto impedirá que se use {name}. Puedes rotarla más tarde.', 'settings.providers.webV2Credentials.confirm.deleteTitle': '¿Eliminar credencial?', 'settings.providers.webV2Credentials.confirm.deleteDescription': 'Esto eliminará permanentemente {name}. Esta acción no se puede deshacer.',
} as const;
