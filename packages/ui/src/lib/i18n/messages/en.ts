...
export const dict = {
  ...
  'shareOpinion.actions.shareOpinion': 'Share opinion',
  'shareOpinion.actions.bookCall': 'Book a call',
  'shareOpinion.actions.shortSurvey': 'Short survey',
  'shareOpinion.dialog.title': 'Share your opinion',
  'shareOpinion.toast.title': 'Help shape OpenChamber',
  'shareOpinion.toast.description': 'Share what is useful, confusing, or missing to help shape what comes next.',
  'sessions.sidebar.footer.actions.shareOpinion': 'Share opinion',
