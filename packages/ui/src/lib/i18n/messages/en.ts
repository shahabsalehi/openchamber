...
export const dict = {
  ...
  'sessions.sidebar.session.menu.copyReference': 'Copy session reference',
  ...
  'sessions.sidebar.session.reference.success': 'Session reference copied',
  'sessions.sidebar.session.reference.copyError': 'Failed to copy session reference',
