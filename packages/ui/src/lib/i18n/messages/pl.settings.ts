export const settingsDict = {
  ...
  'settings.openchamber.desktopNetwork.field.windowControlsPositionDescription': 'Wybierz, gdzie mają się pojawiać przyciski minimalizacji, maksymalizacji i zamykania. Automatycznie dopasowuje się do systemu operacyjnego.',
  'settings.openchamber.desktopNetwork.field.windowControlsPositionAria': 'Pozycja elementów sterujących oknem',
  'settings.openchamber.desktopNetwork.option.windowControlsAuto': 'Automatycznie',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.providers.webV2Credentials.title': 'Zarządzane poświadczenia', 'settings.providers.webV2Credentials.info': 'Twórz, rotuj, unieważniaj lub usuwaj zarządzane poświadczenia dostawcy. Wartości nie są wyświetlane po wpisaniu.', 'settings.providers.webV2Credentials.error.load': 'Nie udało się wczytać zarządzanych poświadczeń. Ostatnio wczytane pozostają dostępne.', 'settings.providers.webV2Credentials.error.mutation': 'Nie udało się zaktualizować poświadczenia. Sprawdź wartość i spróbuj ponownie.',
  'settings.providers.webV2Credentials.create.nameLabel': 'Nazwa poświadczenia', 'settings.providers.webV2Credentials.create.namePlaceholder': 'production-openai', 'settings.providers.webV2Credentials.create.nameAria': 'Nazwa poświadczenia', 'settings.providers.webV2Credentials.create.valueLabel': 'Wartość poświadczenia', 'settings.providers.webV2Credentials.create.valuePlaceholder': 'Wpisz nową wartość', 'settings.providers.webV2Credentials.create.valueAria': 'Nowa wartość poświadczenia', 'settings.providers.webV2Credentials.list.title': 'Zarządzane poświadczenia', 'settings.providers.webV2Credentials.rotate.valueLabel': 'Nowa wartość poświadczenia', 'settings.providers.webV2Credentials.rotate.valuePlaceholder': 'Wpisz zastępczą wartość', 'settings.providers.webV2Credentials.rotate.valueAria': 'Nowa wartość poświadczenia dla {name}',
  'settings.providers.webV2Credentials.metadata.provider': 'Dostawca: {provider}', 'settings.providers.webV2Credentials.metadata.generation': 'Generacja {generation}', 'settings.providers.webV2Credentials.metadata.created': 'Utworzono {timestamp}', 'settings.providers.webV2Credentials.metadata.updated': 'Zaktualizowano {timestamp}', 'settings.providers.webV2Credentials.status.active': 'Aktywne', 'settings.providers.webV2Credentials.status.revoked': 'Unieważnione', 'settings.providers.webV2Credentials.state.loading': 'Wczytywanie zarządzanych poświadczeń…', 'settings.providers.webV2Credentials.state.empty': 'Brak zarządzanych poświadczeń.',
  'settings.providers.webV2Credentials.actions.create': 'Utwórz', 'settings.providers.webV2Credentials.actions.creating': 'Tworzenie…', 'settings.providers.webV2Credentials.actions.refresh': 'Odśwież', 'settings.providers.webV2Credentials.actions.rotate': 'Rotuj', 'settings.providers.webV2Credentials.actions.rotating': 'Rotowanie…', 'settings.providers.webV2Credentials.actions.revoke': 'Unieważnij', 'settings.providers.webV2Credentials.actions.revoking': 'Unieważnianie…', 'settings.providers.webV2Credentials.actions.delete': 'Usuń', 'settings.providers.webV2Credentials.actions.deleting': 'Usuwanie…', 'settings.providers.webV2Credentials.actions.cancel': 'Anuluj', 'settings.providers.webV2Credentials.confirm.revokeTitle': 'Unieważnić poświadczenie?', 'settings.providers.webV2Credentials.confirm.revokeDescription': 'To zatrzyma użycie {name}. Możesz je później zrotować.', 'settings.providers.webV2Credentials.confirm.deleteTitle': 'Usunąć poświadczenie?', 'settings.providers.webV2Credentials.confirm.deleteDescription': 'To trwale usunie {name}. Tej operacji nie można cofnąć.',
};
