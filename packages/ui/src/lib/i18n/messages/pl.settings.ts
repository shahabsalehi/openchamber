...
export const settingsDict = {
  ...
  'settings.integrations.discord.commands.desc.addDir': 'Pokaż obsługę dostępu do dodatkowego folderu',
  ...
  'settings.integrations.discord.commands.desc.forkSubagent': 'Wyjaśnij dostępność forkowania subagenta',
  'settings.integrations.discord.commands.desc.restartOpencodeServer': 'Przeładuj lub połącz ponownie serwer OpenCode',
