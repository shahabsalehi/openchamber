...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "shareOpinion.actions.shareOpinion": "Compartilhar opinião",
  "shareOpinion.actions.bookCall": "Agendar chamada",
  "shareOpinion.actions.shortSurvey": "Pesquisa breve",
  "shareOpinion.dialog.title": "Compartilhe sua opinião",
  "shareOpinion.toast.title": "Ajude a moldar o OpenChamber",
  "shareOpinion.toast.description": "Conte o que é útil, confuso ou está faltando para ajudar a definir os próximos passos.",
  "sessions.sidebar.footer.actions.shareOpinion": "Compartilhar opinião",
