...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "sessions.sidebar.session.menu.copyReference": "Copiar referência da sessão",
  ...
  "sessions.sidebar.session.reference.success": "Referência da sessão copiada",
  "sessions.sidebar.session.reference.copyError": "Não foi possível copiar a referência da sessão",
