...
export const dict: Record<I18nKey, string> = {
  ...
  "shareOpinion.actions.shareOpinion": "Compartir opinión",
  "shareOpinion.actions.bookCall": "Reservar llamada",
  "shareOpinion.actions.shortSurvey": "Encuesta breve",
  "shareOpinion.dialog.title": "Comparte tu opinión",
  "shareOpinion.toast.title": "Ayuda a dar forma a OpenChamber",
  "shareOpinion.toast.description": "Cuenta qué es útil, confuso o falta para ayudar a definir lo que viene después.",
  "sessions.sidebar.footer.actions.shareOpinion": "Compartir opinión",
