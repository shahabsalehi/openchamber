...
export const dict: Record<I18nKey, string> = {
  ...
  "diffView.mode.single.label": "Archivo único",
  "diffView.mode.single.description": "Mostrar un archivo a la vez",
  "diffView.mode.stacked.label": "Todos los archivos",
  ...
  "chat.textSelection.title.saveInsightToNotes": "Guardar información destilada en notas",
  ...
  "onboarding.localSetup.windows.title": "Configuración de Windows (recomendado WSL)",
  "onboarding.localSetup.windows.stepInstallWsl": "Instala WSL (si es necesario) con",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta OpenCode en WSL para mayor compatibilidad.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Si la detección falla, establece una ruta nativa (opencode.cmd/opencode.exe), wsl.exe, o wsl:/usr/local/bin/opencode.",
