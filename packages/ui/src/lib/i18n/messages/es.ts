...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.menu.copyReference": "Copiar referencia de sesión",
  ...
  "sessions.sidebar.session.reference.success": "Referencia de sesión copiada",
  "sessions.sidebar.session.reference.copyError": "No se pudo copiar la referencia de sesión",
