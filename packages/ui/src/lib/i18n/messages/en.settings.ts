export const settingsDict = {
  ...
  'settings.remoteInstances.clientAuth.addDevice.transportLabel': 'How this device connects',
  'settings.remoteInstances.clientAuth.addDevice.transport.local': 'This computer',
  'settings.remoteInstances.clientAuth.addDevice.transport.lan': 'Local network',
  'settings.remoteInstances.clientAuth.addDevice.transport.relay': 'Private relay',
  'settings.remoteInstances.clientAuth.addDevice.fallback.relay': 'Also connect via the relay when away from this network',
  'settings.remoteInstances.clientAuth.addDevice.fallback.preferLocal': 'Prefer the local network when available',
  'settings.remoteInstances.clientAuth.addDevice.create': 'Create link',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
