export const settingsDict = {
  ...
  'settings.providers.webV2Credentials.title': 'Managed credentials',
  'settings.providers.webV2Credentials.info': 'Create, rotate, revoke, or delete managed provider credentials. Credential values are never shown after you enter them.',
  'settings.providers.webV2Credentials.error.load': 'Could not load managed credentials. Your last loaded credentials remain available.',
  'settings.providers.webV2Credentials.error.mutation': 'Could not update the credential. Check the value and try again.',
  'settings.providers.webV2Credentials.create.nameLabel': 'Credential name',
  'settings.providers.webV2Credentials.create.namePlaceholder': 'production-openai',
  'settings.providers.webV2Credentials.create.nameAria': 'Credential name',
  'settings.providers.webV2Credentials.create.valueLabel': 'Credential value',
  'settings.providers.webV2Credentials.create.valuePlaceholder': 'Enter a new credential value',
  'settings.providers.webV2Credentials.create.valueAria': 'New credential value',
  'settings.providers.webV2Credentials.list.title': 'Managed credentials',
  'settings.providers.webV2Credentials.rotate.valueLabel': 'New credential value',
  'settings.providers.webV2Credentials.rotate.valuePlaceholder': 'Enter a replacement credential value',
  'settings.providers.webV2Credentials.rotate.valueAria': 'New credential value for {name}',
  'settings.providers.webV2Credentials.metadata.provider': 'Provider: {provider}',
  'settings.providers.webV2Credentials.metadata.generation': 'Generation {generation}',
  'settings.providers.webV2Credentials.metadata.created': 'Created {timestamp}',
  'settings.providers.webV2Credentials.metadata.updated': 'Updated {timestamp}',
  'settings.providers.webV2Credentials.status.active': 'Active',
  'settings.providers.webV2Credentials.status.revoked': 'Revoked',
  'settings.providers.webV2Credentials.state.loading': 'Loading managed credentials…',
  'settings.providers.webV2Credentials.state.empty': 'No managed credentials yet.',
  'settings.providers.webV2Credentials.actions.create': 'Create',
  'settings.providers.webV2Credentials.actions.creating': 'Creating…',
  'settings.providers.webV2Credentials.actions.refresh': 'Refresh',
  'settings.providers.webV2Credentials.actions.rotate': 'Rotate',
  'settings.providers.webV2Credentials.actions.rotating': 'Rotating…',
  'settings.providers.webV2Credentials.actions.revoke': 'Revoke',
  'settings.providers.webV2Credentials.actions.revoking': 'Revoking…',
  'settings.providers.webV2Credentials.actions.delete': 'Delete',
  'settings.providers.webV2Credentials.actions.deleting': 'Deleting…',
  'settings.providers.webV2Credentials.actions.cancel': 'Cancel',
  'settings.providers.webV2Credentials.confirm.revokeTitle': 'Revoke credential?',
  'settings.providers.webV2Credentials.confirm.revokeDescription': 'This will stop {name} from being used. You can rotate it later.',
  'settings.providers.webV2Credentials.confirm.deleteTitle': 'Delete credential?',
  'settings.providers.webV2Credentials.confirm.deleteDescription': 'This will permanently delete {name}. This action cannot be undone.',
} as const;
