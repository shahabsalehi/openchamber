...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.menu.copyReference': 'Kopiuj odniesienie sesji',
  ...
  'sessions.sidebar.session.reference.success': 'Skopiowano odniesienie sesji',
  'sessions.sidebar.session.reference.copyError': 'Nie udało się skopiować odniesienia sesji',
