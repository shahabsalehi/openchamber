...
export const dict: Record<I18nKey, string> = {
  ...
  'shareOpinion.actions.shareOpinion': 'Podziel się opinią',
  'shareOpinion.actions.bookCall': 'Umów rozmowę',
  'shareOpinion.actions.shortSurvey': 'Krótka ankieta',
  'shareOpinion.dialog.title': 'Podziel się opinią',
  'shareOpinion.toast.title': 'Pomóż kształtować OpenChamber',
  'shareOpinion.toast.description': 'Powiedz, co jest przydatne, mylące albo czego brakuje, aby pomóc kształtować kolejne kroki.',
  'sessions.sidebar.footer.actions.shareOpinion': 'Podziel się opinią',
