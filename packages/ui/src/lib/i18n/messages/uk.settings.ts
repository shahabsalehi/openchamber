...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transportLabel": "Як цей пристрій підключається",
  "settings.remoteInstances.clientAuth.addDevice.transport.local": "Цей комп'ютер",
  "settings.remoteInstances.clientAuth.addDevice.transport.lan": "Локальна мережа",
  "settings.remoteInstances.clientAuth.addDevice.transport.relay": "Приватний relay",
  "settings.remoteInstances.clientAuth.addDevice.fallback.relay": "Також підключатися через relay поза цією мережею",
  "settings.remoteInstances.clientAuth.addDevice.fallback.preferLocal": "Надавати перевагу локальній мережі, коли доступна",
  "settings.remoteInstances.clientAuth.addDevice.create": "Створити посилання",
