...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.desktopNetwork.field.windowControlsPositionDescription": "Виберіть, де з’являються кнопки згортання, розгортання та закриття. Авто відповідає вашій операційній системі.",
  "settings.openchamber.desktopNetwork.field.windowControlsPositionAria": "Позиція елементів керування вікном",
  "settings.openchamber.desktopNetwork.option.windowControlsAuto": "Авто",
  ...
  'settings.providers.webV2Credentials.title': 'Керовані облікові дані', 'settings.providers.webV2Credentials.info': 'Створюйте, оновлюйте, відкликайте або видаляйте керовані облікові дані постачальника. Значення ніколи не показуються після введення.', 'settings.providers.webV2Credentials.error.load': 'Не вдалося завантажити керовані облікові дані. Останні завантажені дані залишаються доступними.', 'settings.providers.webV2Credentials.error.mutation': 'Не вдалося оновити облікові дані. Перевірте значення та спробуйте ще раз.',
  'settings.providers.webV2Credentials.create.nameLabel': 'Назва облікових даних', 'settings.providers.webV2Credentials.create.namePlaceholder': 'production-openai', 'settings.providers.webV2Credentials.create.nameAria': 'Назва облікових даних', 'settings.providers.webV2Credentials.create.valueLabel': 'Значення облікових даних', 'settings.providers.webV2Credentials.create.valuePlaceholder': 'Введіть нове значення', 'settings.providers.webV2Credentials.create.valueAria': 'Нове значення облікових даних', 'settings.providers.webV2Credentials.list.title': 'Керовані облікові дані', 'settings.providers.webV2Credentials.rotate.valueLabel': 'Нове значення облікових даних', 'settings.providers.webV2Credentials.rotate.valuePlaceholder': 'Введіть замінне значення', 'settings.providers.webV2Credentials.rotate.valueAria': 'Нове значення для {name}',
  'settings.providers.webV2Credentials.metadata.provider': 'Постачальник: {provider}', 'settings.providers.webV2Credentials.metadata.generation': 'Покоління {generation}', 'settings.providers.webV2Credentials.metadata.created': 'Створено {timestamp}', 'settings.providers.webV2Credentials.metadata.updated': 'Оновлено {timestamp}', 'settings.providers.webV2Credentials.status.active': 'Активні', 'settings.providers.webV2Credentials.status.revoked': 'Відкликані', 'settings.providers.webV2Credentials.state.loading': 'Завантаження керованих облікових даних…', 'settings.providers.webV2Credentials.state.empty': 'Керованих облікових даних ще немає.',
  'settings.providers.webV2Credentials.actions.create': 'Створити', 'settings.providers.webV2Credentials.actions.creating': 'Створення…', 'settings.providers.webV2Credentials.actions.refresh': 'Оновити', 'settings.providers.webV2Credentials.actions.rotate': 'Оновити', 'settings.providers.webV2Credentials.actions.rotating': 'Оновлення…', 'settings.providers.webV2Credentials.actions.revoke': 'Відкликати', 'settings.providers.webV2Credentials.actions.revoking': 'Відкликання…', 'settings.providers.webV2Credentials.actions.delete': 'Видалити', 'settings.providers.webV2Credentials.actions.deleting': 'Видалення…', 'settings.providers.webV2Credentials.actions.cancel': 'Скасувати', 'settings.providers.webV2Credentials.confirm.revokeTitle': 'Відкликати облікові дані?', 'settings.providers.webV2Credentials.confirm.revokeDescription': 'Це зупинить використання {name}. Ви зможете оновити їх пізніше.', 'settings.providers.webV2Credentials.confirm.deleteTitle': 'Видалити облікові дані?', 'settings.providers.webV2Credentials.confirm.deleteDescription': 'Це назавжди видалить {name}. Цю дію неможливо скасувати.',
} as const;
